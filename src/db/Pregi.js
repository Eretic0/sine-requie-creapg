...
/* *** Manuale Base - Begin *** */
  {
    ...
    nome: "Affascinante",
    numeroDifetti: 2,
    descrizioneBreve: "+1 ai Test su Caratteristiche di Quadri verso il sesso opposto",
    descrizione: "Hai qualcosa che ti fa avere un certo ascendente sul sesso opposto, forse la voce, il portamento o il modo in cui parli... (+1 ai Test su Caratteristiche di Quadri verso il sesso opposto).",
  },
  {
    ...
    numeroDifetti: 2,
    descrizioneBreve: "",
    descrizione: "Qualcuno ti ama e farà di tutto per dimostrartelo! Avrai un aiuto fidato e sempre pronto in qualunque situazione; lei/lui arriverà a mettere a repentaglio la propria vita per salvarti o proteggerti se sarà necessario.",
  },
  {
    ...
    numeroDifetti: 1,
    descrizioneBreve: "",
    descrizione: "Attaccare con due spade, sparare con due pistole, bere due caffè contemporaneamente... uno scherzo per te! Grazie a questo Pregio non subirai alcun Malus (normalmente -2 al Test per colpire) utilizzando armi o altri oggetti con l'arto non dominante.",
  },
  {
    ...
    numeroDifetti: 1,
    descrizioneBreve: "",
    descrizione: "Questo Pregio ti permette di scrivere bene e comprensibilmente anche in situazioni disagiate o concitate. Se hai a disposizione tempo e strumenti adatti, il tuo scrivere può diventare una vera forma d'arte e col dovuto insegnamento potresti diventare un ottimo miniaturista.",
  },
  {
    ...
    descrizione: "Hai una voce particolare e piena di personalità, ottima per cantare in un'opera lirica o in un complesso famoso (+2 ai Test di \"Cantare\")",
  },
  {
  ...
  },
  {
    ...
    numeroDifetti: 1,
    descrizioneBreve: "",
    descrizione: "Sei conosciuto e stimato come persona. La gente sarà generalmente propensa ad aiutarti, senza però esporsi o rischiare in prima persona; è probabile che tu riceva sconti nei negozi, che tutti ti salutino cordialmente, che qualche mamma ti veda come buon partito per la figlioletta o che nessuno ti rifiuti un prestito. Non è pensabile che per te si gettino verso morte certa o vadano contro ai propri principi.",
  },
  {
    id: "341972247204856012",
    nome: "Comportamento educato",
    numeroDifetti: 1,
    descrizioneBreve: "+1 a Socievolezza durante incontri che richiedano una certa etichetta",
    descrizione: "Conosci le regale della buona educazione, non sarai a disagio né a cena con i suoceri né a un gala dell'alta società, sarai all'altezza della situazione, evitando imbarazzanti gaffe e mostrandoti sicuro e a tuo agio (+1 a Socievolezza durante incontri che richiedano una certa etichetta).",
  },
  {
  ...
  },
  {
    ...
    descrizione: "Sai come affrontare la paura, come chiuderla nel tuo cuore senza che domini le tue azioni; niente e nessuno può spaventarti: sergenti iracondi, sangue, armi, pericolo... Morti... ci vorrà ben altro per uno tosto come te! (+3 ai Test di Paura).",
  },
  {
    ...
    numeroDifetti: 1,
    descrizioneBreve: "",
    descrizione: "Le tue giunture possono resistere a insulti pesanti senza grossi problemi: puoi toglierti manette, attraversare pertugi strettissimi, rannicchiarti in posti piccolissimi come casse o barili per non farti scoprire o grattarti l'orecchio destro col piede sinistro...",
  },
  {
    ...
    numeroDifetti: 1,
    descrizioneBreve: "",
    descrizione: "Hai un'Abilità (a Grado +0) in più... nessuno te l'ha insegnata ma la conosci di fatto, quasi istintivamente. Può essere qualunque Abilità che non richieda un vero studio per essere appresa.",
  },
  {
  ...
  },
  {
    ...
    descrizione: "Nessun volto ti sfugge, nessuna particolare camminata, espressione o sguardo sono da te sottovalutati o dimenticati. Puoi riconoscere una persona anche dopo che il tempo, la guerra o un pesante trucco ne abbiano modificato parzialmente i lineamenti (+3 a Memoria per il riconoscimento di volti)",
  },
  {
    ...
    descrizione: "Giocare è sempre stato il tuo forte, hai una fortuna sfacciata e irritante... per chi gioca contro di te! (+3 ai Test \"Gioco d'azzardo\")",
  },
  {
    ...
    descrizione: "Tutto ciò che fai nel campo dell'arte è considerato geniale o per lo più gradevole, riesci un po' in tutto: pittura, musica, scultura... (+1 a Creatività)",
  },
  {
    ...
    descrizione: "Sai cos'è bello, cos'è elegante e raffinato e la tua figura, così come gli oggetti di cui ti circondi, ne sono testimonianza indelebile (+1 a Aspetto)",
  },
  {
    id: "341972460271304908",
    nome: "Iniziazione occulta",
    numeroDifetti: 3,
    descrizioneBreve: "+2 a Affinità Occulta, se essa è maggiore di 8 possiedi anche un potere innato",
    descrizione: "Qualcuno, nella tua infanzia, ti ha iniziato alla conoscenza della vera magia, oppure semplicemente sei nato così... un po' strano, capace di vedere o sentire cose che agli altri sono da sempre negate (+2 a Affinità Occulta, se essa è maggiore di 8 possiedi anche un potere innato).",
  },
  {
    ...
    numeroDifetti: 1,
    descrizioneBreve: "",
    descrizione: "Puoi leggere così velocemente da non essere visto o notato mentre lo fai (nessuno penserà che in quella manciata di secondi tu abbia letto tutto quanto...) o da terminare un libro nella metà del tempo.",
  },
  {
    ...
    descrizione: "Potranno immergerti in una vasca di sangue, gettarti in un pozzo abitato da viscidi vermi striscianti, costringerti a guardare tua madre sbranata dai Morti... forse resisterai all'orrore (Bonus +2 sui Test di Orrore)",
  },
  {
    ...
    descrizione: "Troveresti la strada di casa anche se ti risvegliassi in un bosco di notte; ti bastano pochi particolari per orientarti e, col cielo sereno, potrai ritornare dall'Inferno seguendo le stelle! (+3 ai Test di \"Orientamento\")",
  },
  {
    ...
    numeroDifetti: 1,
    descrizioneBreve: "",
    descrizione: "Sai sempre che ore sono, ti svegli sempre all'ora giusta e sai quando è ora di cena; anche chiuso in una cella o in una grotta saprai sempre ora e giorno, anche dopo settimane. Utile per prevedere ronde e turni di guardia...",
  },
  {
    ...
    descrizione: "hai una vista ottima e sai porre attenzione a ciò che vedi. Hai quello che si dice un \"occhio di falco\". Non hai solo degli occhi perfetti, hai anche un metodo di osservazione che ti permette di vedere più cose e di porvi maggior attenzione, di ricostruire mentalmente immagini poco chiare o frammentarie con una certa precisione (+1 ai Test \"Osservare\").",
  },
  {
    ...
    descrizione: "Riconosci odori e sapori con una certa precisione e anche a distanza di molto tempo... se c'è qualcosa di strano nel tuo pollo, tu lo sentirai anche senza assaggiarlo! (+2 ai Test su odori e sapori).",
  },
  {
    ...
    descrizione: "Hai un udito spaventosamente sensibile e sai porre attenzione alle stimolazioni sonore, scomporle, comprenderle e processarle con cura nella tua mente. Insomma non solo \"senti meglio\" ma soprattutto capisci meglio quello che senti (+1 ai Test \"Ascoltare\").",
  },
  {
    ...
    numeroDifetti: 1,
    descrizioneBreve: "",
    descrizione: "Parleresti per ore indipendentemente da quale sia l'argomento intavolato e da chi sia il tuo interlocutore, fino a farlo desistere o persino a farlo fuggire educatamente. Non ti mancano gli argomenti, siano essi interessanti o squisitamente futili.",
  },
  {
    ...
    numeroDifetti: 1,
    descrizioneBreve: "",
    descrizione: "Impari i fondamentali di lingue straniere con velocità impressionante; se ti mandassero in un paese straniero, in pochi giorni sapresti già cavartela discretamente. Ogni volta che apprendi un Grado di Lingua puoi sommare uno aggiuntivo.",
  },
  {
    ...
    numeroDifetti: 2,
    descrizioneBreve: "",
    descrizione: "Hai qualcosa che ti è stato regalato, oppure che un vero e proprio cimelio di famiglia: un fucile d'epoca, un dipinto costoso, un'auto o un biplano ancora funzionante...",
  },
  {
    ...
    numeroDifetti: 1,
    descrizioneBreve: "",
    descrizione: "L'ordine è la tua fissazione, saprai sempre dove hai riposto un oggetto, dove cercare una scheda, in quale ordine disporre i tuoi libri, ma sei ordinato anche nello scrivere, nel vestire e in generale nell'organizzarti la vita.",
  },
  {
  ...
  },
  {
    ...
    numeroDifetti: 2,
    descrizioneBreve: "",
    descrizione: "Hai un conto in banca esagerato... e l'hai avuto senza muovere un dito, solo un colpo di fortuna! Ora dovrai essere bravo ad amministrarlo.",
  },
  {
    id: "341972685885014220",
    nome: "Romantico",
    numeroDifetti: 1,
    descrizioneBreve: "Bonus di +1 a Creatività e nei Test finalizzati a sedurre un partner",
    descrizione: "hai uno spirito poetico e sognatore che affascina l'altro sesso e ti rende un poeta qualunque cosa tu faccia; se questa sensibilità viene affiancata a una forma d'arte, essa risulterà più sdolcinata e commovente (Bonus di +1 a Creatività e nei Test finalizzati a sedurre un partner).",
  },
  {
    ...
    descrizione: "Sei bravissimo a mentire e anche se non è detto che tu lo faccia spesso, quando ti capita di farlo nessuno ti scopre. Se le bugie hanno le gambe corte nel tuo caso le muovono veloci! (+2 ai Test \"Raggirare\").",
  },
  {
    ...
    descrizione: "Sei sempre pronto a difenderti, i tuoi sensi sono sempre all'erta, probabilmente sei un po' iperteso e nervoso, ma in compenso sarà difficile prenderti in castagna. (+2 a Risoluzione).",
  },
  {
    ...
    numeroDifetti: 2,
    descrizioneBreve: "",
    descrizione: "Se ti trovi in una situazione di crisi puoi fare di tutto, hai una conoscenza rudimentale di ogni terreno, conosci ricette improbabili e hai risorse così nascoste che non sapevi di avere.",
  },
  {
    ...
    descrizione: "Hai la musica nel sangue. Hai un gusto sopraffino e un'incredibile abilità nell'imparare l'uso di uno strumento o nel ricordare, anche per intero, pezzi musicali di ogni tipo (+1 ai Test \"Suonare -strumento-\").",
  },
  {
    ...
    numeroDifetti: 3,
    descrizioneBreve: "",
    descrizione: "A volte prima che ti succeda qualcosa di grave hai come un presentimento, come un lieve malessere o un lieve senso di angoscia, sarà difficile però interpretarlo in modo corretto e tempestivo.",
  },
  {
    ...
    descrizione: "Qualunque cosa tu dica scatenerai il sorriso e, spesso, il riso irrefrenabile... che fai per Capodanno? (+1 a Socievolezza).",
  },
  {
    ...
    numeroDifetti: 1,
    descrizioneBreve: "",
    descrizione: "Sei sempre all'erta come un predatore (in realtà come una preda), sei pronto a scattare al minimo segnale di pericolo o di allarme; se vuoi farti una dormita come si deve è bene che ti prenda delle pillole.",
  },
  {
    ...
    numeroDifetti: 1,
    descrizioneBreve: "",
    descrizione: "Indipendentemente da come sei come persona, ciò che fai sul lavoro ha una qualità ineccepibile, sei stimato e visto come punto di riferimento nell'ambiente lavorativo.",
  },
  {
    ...
    numeroDifetti: 1,
    descrizioneBreve: "",
    descrizione: "I tuoi caratteri sessuali sono prorompentemente visibili o intuibili e ciò ti rende stimato e invidiato (segretamente) dai tuoi \"simili\", ma desiderata morbosamente dall'altro sesso (non da ognuno ma da molti esponenti... sicuramente i meno poetici...)",
  },
  {
    ...
    descrizione: "Puoi impostare la voce dandogli un tono diverso molto marcato e convincente così da adattarla alla situazione in maniera vantaggiosa: amore, rispetto, calma ... (+1 a Test \"Persuadere\").",
  },
  {
    ...
    numeroDifetti: 2,
    descrizioneBreve: "",
    descrizione: "Hai una faccia... banale... questo non vuol dire che tu sia brutto, ma è difficile che qualcuno si ricordi il tuo volto a meno che non ti conosca bene."
  },
/* *** Manuale Base - End *** */
